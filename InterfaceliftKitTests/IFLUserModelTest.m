...
@interface IFLUserModelTest : XCTestCase
@property(strong,nonatomic) NSData* JSONData;
@end

@implementation IFLUserModelTest
...
- (void)setUp
{
    ...
    NSString* jsonPath   = [mainBundle pathForResource:@"user" ofType:@"json"];
...
-(void)testConstruction
{
    ...
    IFLUser* lens = [[IFLUser alloc]init];

...
@interface IFLLensModelTest : XCTestCase
@property(strong,nonatomic) NSData* JSONData;
@end

@implementation IFLLensModelTest
...
- (void)setUp
{
    ...
    NSString* jsonPath   = [mainBundle pathForResource:@"camera_lens" ofType:@"json"];
...
-(void)testConstruction
{
    ...
    IFLLens* lens = [[IFLLens alloc]init];

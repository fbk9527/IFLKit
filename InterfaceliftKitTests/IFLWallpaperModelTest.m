...
@interface IFLWallpaperModelTest : XCTestCase
@property(strong,nonatomic) NSData* JSONData;
@end

@implementation IFLWallpaperModelTest
...
- (void)setUp
{
    ...
    NSString* jsonPath   = [mainBundle pathForResource:@"wallpaper" ofType:@"json"];
...
-(void)testConstruction
{
    ...
    IFLWallpaper* lens = [[IFLWallpaper alloc]init];

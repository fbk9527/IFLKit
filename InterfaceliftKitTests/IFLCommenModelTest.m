...
@interface IFLCommenModelTest : XCTestCase
@property(strong,nonatomic) NSData* JSONData;
@end

@implementation IFLCommenModelTest
...
- (void)setUp
{
    ...
    NSString* jsonPath   = [mainBundle pathForResource:@"comment" ofType:@"json"];
...
-(void)testConstruction
{
    ...
    IFLComment* lens = [[IFLComment alloc]init];
